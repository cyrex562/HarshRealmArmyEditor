package com.fcl.harshrealm.armyeditor;

import java.util.Locale;

import com.fcl.harshrealm.armyeditor.services.HRAE_Service;
...
public class MainActivity extends FragmentActivity {
	...
	private HRAE_Service dataModelSvc;
	/** TODO. */
	...
	private ServiceConnection dataModelSvcConn = new ServiceConnection() {
		...
		public void onServiceConnected(ComponentName className, 
			IBinder service) {
			dataModelSvc =
				((HRAE_Service.DataModelSvcBinder)service).getService();
	...
	private void doBindService() {
		bindService(new Intent(MainActivity.this, HRAE_Service.class),
